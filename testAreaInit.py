...
def compile():
    ...
    call(["gcc", "-std=gnu90", prefix + "Pprocess/processP.c", prefix + "Pprocess/processPfunc.c", prefix + "Pprocess/OnTheFly/onTheFlyHandler.c", prefix + "Debug/utility.c", prefix + "macro_libglob.c", "-o", "/TestArea/Executable/P.out"])
    call(["gcc", "-std=gnu90", prefix + "Analizer/analizer.c", prefix + "Debug/utility.c", prefix + "Analizer/CheckInput/inputcheck.c", prefix + "Analizer/CheckInput/pPreprocessing.c", prefix + "Analizer/ReadMessage/messageHandler.c", prefix + "Analizer/OnTheFly/onTheFlyHandler.c", prefix + "Analizer/WriteToReport/messageToReport.c", prefix + "macro_libglob.c", "-lm", "-o", "/TestArea/Executable/A.out"])
    call(["gcc", "-std=gnu90", prefix + "Main/main.c", prefix + "Main/mainfunc.c", prefix + "Main/messages.c", "-o", "/TestArea/Executable/Main.out"])
